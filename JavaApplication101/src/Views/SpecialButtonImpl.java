...
public class SpecialButtonImpl extends SpecialButton implements KeyListener, ActionListener{    
     ...
     */
    public SpecialButtonImpl(String mssg, int newXMin, int newXMax, int newYMin, int newYMax) {
